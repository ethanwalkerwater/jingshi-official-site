...
export function avgScore(t: Teacher): string {
  ...
  return ((improvement + responsibility + charisma) / 3).toFixed(1);
}

/**
 * 菁仕名师团队。数据来源于教研整理的「老师卡片」。
 * ⚠️ ratings（三项评分）目前为占位值，请在 CONTENT-TODO 中按真实评测替换。
 */
export const teachers: Teacher[] = [
  {
    ...
    ratings: { improvement: 5.0, responsibility: 4.9, charisma: 4.8 },
    featured: true,
  },
  {
    name: "包天翊",
    ...
    education: "香港中文大学金融数学硕士、曼彻斯特大学数学系本科。",
    style:
      "深度讲解数学逻辑推导与实际应用，帮助学生建立严谨的数学思维体系；注重「理解 + 应用」结合，提升解决复杂问题的能力；关注学生身心发展，正向引导激发内驱力，风格稳定扎实，适合长期体系化提升。IB 数学 HL 7 分案例。",
    ratings: { improvement: 4.8, responsibility: 4.9, charisma: 4.7 },
  },
  {
    name: "张文豪",
    subject: "数学",
    ...
    ratings: { improvement: 4.8, responsibility: 4.8, charisma: 4.9 },
  },
  {
    name: "张劭景",
    subject: "数学",
    ...
    ratings: { improvement: 4.7, responsibility: 4.8, charisma: 5.0 },
    featured: true,
  },
  {
    name: "陈璐怡",
  ...
  },
  {
    ...
    ratings: { improvement: 4.7, responsibility: 4.8, charisma: 4.7 },
  },
  {
    name: "郑唯梓",
    subject: "数学",
    ...
    ratings: { improvement: 4.9, responsibility: 4.8, charisma: 4.7 },
  },
  {
    name: "李品轩",
    subject: "物理",
    ...
    ratings: { improvement: 4.9, responsibility: 5.0, charisma: 4.9 },
    featured: true,
  },
  {
    name: "汤朔",
    ...
    ratings: { improvement: 4.9, responsibility: 4.8, charisma: 4.9 },
    featured: true,
  },
  {
    name: "王冰青",
    ...
    ratings: { improvement: 4.9, responsibility: 4.9, charisma: 4.8 },
  },
  {
    name: "李寅鑫",
    subject: "化学",
  ...
  },
  {
    ...
    ratings: { improvement: 4.7, responsibility: 4.9, charisma: 4.8 },
  },
  {
    name: "刘艳阳",
    subject: "经济",
    ...
    ratings: { improvement: 5.0, responsibility: 4.8, charisma: 4.8 },
    featured: true,
  },
  {
    name: "马怡婷",
  ...
  },
  {
    ...
    ratings: { improvement: 4.9, responsibility: 4.8, charisma: 4.8 },
  },
  {
    name: "蓝浪",
    subject: "英语",
  ...
  },
  {
    ...
    ratings: { improvement: 4.9, responsibility: 4.8, charisma: 5.0 },
    featured: true,
  },
  {
    name: "王储君",
    ...
    ratings: { improvement: 4.8, responsibility: 5.0, charisma: 4.8 },
  },
  {
    name: "罗健文",
    subject: "英语",
    ...
    ratings: { improvement: 4.8, responsibility: 4.9, charisma: 4.8 },
  },
];
